      ...
      <div>
        <div className="container-fluid m-0 p-0">
          <div className="container-fluid m-0 p-0">
            <img
              src={hero_img}
              alt="Petshop Hero Image"
              className=" img-fluid object-fit-cover vw-100"
            />
          </div>
          <div className="row justify-content-center petshop-home-sizing">
            <div className="col-8 mx-auto offset-md-2 justify-content-center d-flex align-items-center">
              <p className="m-3 mb-0 text-secondary">
                WHAT <s>WE</s> OFFER
              </p>
            </div>
          </div>
          ...
          <div className="container-fluid row">
            ...
            <div className="col-6">
              ...
              <p className="fw-light">
                Simply enter your city above to start the search.Once you find a
                pet,click "show number" to get contact info for their pet parent
                or rescue. Contact them to learn more about how to meet and
                adopt the pet.
              </p>
              <button className="btn btn-primary btn-lg rounded-4 m-2">
                Contact Us
              </button>
            </div>
          </div>
          ...
          <div className="homepagediv53 m-5 petshop-home-box">
            <div className="homepagediv50">
              <div className="homepagediv51">
                ...
                <button className="btn btn-primary btn-lg rounded-4 m-5 mx-0 position-absolute top-100 start-50 translate-middle">
                  READ MORE
                </button>
              </div>
              <div></div>
            ...
            <div className="homepagediv50">
              <div className="homepagediv51">
                ...
                <div className="homepagediv52">
                  ...
                  <p>
                    With proper pet grooming, you will get rid of shedding,
                    fleas, ticks and various health conditions.
                  </p>
                </div>
                <button className="btn btn-primary btn-lg rounded-4 m-5 mx-0 position-absolute top-100 start-50 translate-middle">
                  READ MORE
            ...
            <div className="homepagediv50">
              <div className="homepagediv51">
                ...
                <div className="homepagediv52">
                  ...
                  <p>
                    You can surrender your dog by taking him to an animal
                    shelter or rescue organization and they will do the rest.
                  </p>
                </div>
                <button className="btn btn-primary btn-lg rounded-4 m-5 mx-0 position-absolute top-100 start-50 translate-middle">
                  READ MORE
          ...
          <div className="container-fluid row mt-5">
            ...
            <div className="col-8 p-4">
              ...
              <p className="fw-medium fs-5">
                Pets, whether dogs,cats or any farm animals - make great friends
                for everyone in the family because they are a great source of
                love and friendship. Pets are playful beings in the house as
                they keep everyone,young and old, happy in the house.
              </p>
              <button className="btn btn-primary btn-lg rounded-4 m-5 mx-0">
                MORE ABOUT US
              </button>
            </div>
          </div>
          ...
          <div className="container-fluid row">
            <div className="col-12 position-relative">
              <img
                ...
                className="img-fluid object-fit-cover vw-100"
              />
              <button className="btn btn-primary btn-lg rounded-5 m-5 mx-0 position-absolute top-50 start-50 translate-middle petshop-home-custom-btn">
                VIEW GALLERY
              </button>
            </div>
          </div>
